...
public class BaseStream {
    ...
    public BaseStream(R5ConnectionListener listener, String ipAddress) {
        configuration = new R5Configuration(R5StreamProtocol.RTSP, ipAddress,  Red5ProApiInteractor.STREAM_PORT, Red5ProApiInteractor.APP_NAME, 1.0f);
